...
/** 登陆接口
 ...
 此接口为用户登陆的接口，在上传用户数据时，您必须先登陆，登陆只进行一次即可，登陆为异步的过程，在这个过程中，您不可以将这个对象释放掉 注意看开发文档，这样会极大的节省您的时间，如有什么问题可以发邮件到msp_support@CMCC.com，我们很乐意帮助您。
